...
file_path = "dados_irrigacao_aumentados.csv"  # Atualize o caminho conforme necessário
...
if pagina == "Monitoramento":
    ...
    # Contagem de linhas que precisam ou não de irrigação
